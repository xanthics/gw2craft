...
def printtofile(tcost, treco, sell, craftexo, mTiers, make, pmake, buy, tierbuy, cList, filename, mytime, cListName, localText, backupkey, free):
	...
	for item in buy:
			if item in karma_chef:
				...
				b_mix[item] = buy[item]
	karma_str = "<div class=\"s{0}\"><input type=\"checkbox\" /><span class=\"itemIcon\" style=\"background-image: url({1});\"></span><input type=\"number\" onkeypress=\"return event.charCode >= 48\" oninput=\"updateNeed(this, {2}, '{9}bv');\" id=\"{9}ih\" placeholder='0' min=\"0\" /><input type=\"number\" id=\"{9}bv\" value='{2}' raw_copper='0' readonly data-need = \"more\" min=\"0\" /> <button title=\""+localText.toggle+"\" class=\"{3} arrow\" id=\"{4}\">{5}</button><div class=\"lsbutton\" id=\"1{6}\">{7} <span class=\"karmaIcon\"></span> "+localText.valuePer+" 25 <br /> {8}</div></div>\n"
	collectable_str = "<div class=\"s{0}\"><input type=\"checkbox\" /><span class=\"itemIcon\" style=\"background-image: url({1});\"></span><input type=\"number\" onkeypress=\"return event.charCode >= 48\" oninput=\"updateNeed(this, {2}, '{6}bv');\" id=\"{6}ih\" placeholder='0' min=\"0\" /><input type=\"number\" id=\"{6}bv\" value='{2}' raw_copper='{7}' class='vTotal' readonly data-need = \"more\" min=\"0\" /> <span class=\"{3} select_text\">{4}</span> ({5} "+localText.valuePer+")</div>\n"
...
<!-- Ezoic Ad Testing Code-->''')
  ...
  ga('send', 'pageview');
	...
	page.append('<span class=\"warning\"></span><span style="position: relative; top: 4px;"><span style="color: red">%s</span>	%s: %s</span> <a href="/%s/%s%s" style="position: relative; top: 4px;">Permalink</a>\n'%(localText.warning1, localText.warning2, mytime, backupkey, localText.path, filename))
	page.append('</div><br />\n')
...
#	# adword
	...
	page.append("<br /><br /><div class=\"s1\"><input type=\"checkbox\" /><span class=\"itemIcon\" style=\"background-image: url(/apple-touch-icon-144x144-precomposed.png);\"></span><input type=\"text\" value='Have' readonly style=\"width: 4em;\" /><input type=\"text\" value='Need' readonly style=\"width: 4em;\" /> Name of an item and its per unit cost.</div>\n")
	...
	# adword adaptive
	page.append('<br /><div style="width: 100%;display:block;">\n')
	page.append('<!-- Ezoic - Tail - bottom_of_page -->\n<div id="ezoic-pub-ad-placeholder-102"></div>\n<!-- End Ezoic - Tail - bottom_of_page -->')
	page.append('</div>\n')
	page.append('</section>\n')
...
<!-- End Ezoic - Large sidebar - sidebar -->\n\
	...
	# adword adaptive
	page += '<br /><div style="width: 100%;display:block;">\n \
