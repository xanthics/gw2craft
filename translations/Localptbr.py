...
blNotice = u"Aviso: Se está seguindo o guia completo, então já comprou estes materiais.  This buylist may be missing items that are used in later tiers, but are crafted in this tier.  Such as Lucent Motes."
