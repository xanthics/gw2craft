...
a6 = "Script Python 3.7.3 multi-parte que usa um algorítmo e dados de preço do gw2spidy para calcular o menor preço para se aumentar de nível de craft usando fórmulas de dentro do jogo."
