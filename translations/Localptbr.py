...
eRecovery = "Retorno Previsto"
fCost = "Previsão de Custo Final"
sList = "Lista de Venda"
bRecipes = "RECEITAS A COMPRAR"
collectibles = "COLLECTIBLES(Checar Banco ou comprar no Trading Post)"
warning1 = "Não recarrege essa página."
warning2 = "Ela pode mudar. Atualizada"
moreInfo = "Sempre que vir esta %s você pode clicar para mais informações"
soldVia = "Vendido por %s cada através de"
method = ["Vendedor",
"Maior Oferta",
"Menor Preço de Venda"]
valuePer = "cada"
buyVendor = "COMPRAR EM VENDEDOR"
mixedTP = "Mistos (Comprar no Trading Post)"
rTP = "Comprar no Trading Post"
make = "Fazer"
discover = "Descobrir"
expand = "Mostrar todas as receitas a serem descobertas"
collapse = "Esconder todas as receitas a serem descobertas"
tier = "Tier %i. Levels %i-%i"
buyList = "Lista de Compras (Apenas Tier %i)"
blNotice = "Aviso: Se está seguindo o guia completo, então já comprou estes materiais.  This buylist may be missing items that are used in later tiers, but are crafted in this tier.  Such as Lucent Motes."
costRT = "Custo: %s (Total até o momento: %s)"
level = "Level"
finish = "Nada. Você terminou!"
updated = "Atualizado"
note = "<strong>Note:</strong> Os preços mostrados aqui são os custos iniciais e não levam em conta a venda dos itens produzidos."
craft = "Craft"
tiers = "Tier"
...
oThread = "Tópico de Discussão Oficial no Fórum GW2"
rThread = "Tópico de Discussão no reddit"
gThread = "Tópico de Discussão no guildwars2guru"
twitter = "Twitter"
email = "Email"
contact = "Se possui questões, comentários, preocupações ou pensa ter achado um bug, por favor, entre em contato através de um desses métodos."
faq = "FAQ"
question = "P"
answer = "R"
source = "Código fonte?"
q1 = "Quantos níveis posso conseguir com crafting?"
a11 = "A quantidade de experiência que você consegue é determinado pelo seu progresso através dos níveis de crafting baseando-se nos seguintes valores:"
a12 = "1-100 1% do nível atual por nível de crafting"
a13 = "101-200 2% do nível atual por nível de crafting"
a14 = "201-300 3% do nível atual por nível de crafting"
a15 = "301-400 4% do nível atual por nível de crafting"
a16 = "Atualmente, chegar no nível 400 lhe dá cerca de 8 níveis."
a17 = ""
a18 = ""
q2 = "Esses guias não estarão errados assim que o item X sair do mercado?"
a2 = "Esses guias sugerem receitas e compras de itens através dos preços atuais do Trading Post. Eles irão ajustar os itens sugeridos conforme os preços mudam. (Quase) todas as receitas possíveis são consideradas quando os guias são gerados."
q3 = "Várias perguntas sobre chance de crítico ou Crafting Boosters."
a31 = "Esse script assume que não há nenhum crítico, então acertos críticos podem reduzir o número de crafts e, consequentemente, de materiais necessários."
a32 = "Crafting boosters lhe dão +50% de chance de crítico, cumulativa com o bônus da WvW and guild booster. Bônus máximo de 90%. O que um crítico faz é lhe dar 50% a mais de experiência, que é cumulativa com os outros bônus de crafting (discovery, masterwork e rare). Boosters podem fazer com que você precise de menos crafts para chegar ao nível 400, mas não lhe dará mais níveis de personagem."
q4 = "Posso reutilizar ou referenciar seus guias?"
a4 = "Sim, mas esteja ciente que o resultado pode mudar e eu não irei oferecer suporte. Também, por favor, dê a atribuição devida (xanthic.9478 e um link para este site)."
q5 = "Várias questões sobre considerar valores de venda no Trading Post."
a51 = "Balanceamento feito nos valores de venda no Trading Post iria adicionar risco ao preço do guia, já que os preços ficariam estagnados, removendo a habilidade de algumas pessoas para recuperar custos desta forma, tornando o uso do guia mais caro. Atualmente, eu ofereço um \"melhor palpite\" sobre a recuperação de custos baseado na maior oferta ou venda para Vendedores, seja lá qual for o maior, e se o preço mínimo no Trading Post for 0."
a52 = "Também não existem um modo \"automático\" de se determinar se um item vai vender no preço listado."
q6 = "Como você está fazendo estes guias?"
a6 = "Script Python 3.7.3 multi-parte que usa um algorítmo e dados de preço do Anet API para calcular o menor preço para se aumentar de nível de craft usando fórmulas de dentro do jogo."
q7 = "Não, quero dizer, como está fazendo estes guias? (Resposta simples)"
a7 = "Para cada \"criação\", eu gero uma lista de itens, calculo a maior XP/menor custo para se fazer aquele item baseado em criá-lo ou comprar suas partes e então escolho o melhor item para se fazer."
...
t2 = "<input type=\"checkbox\"/> existe para que você possa monitorar sua localização na lista de compras."
t3 = "Listas de compras de Tiers específicos existem para os guias, exceto Cooking (clique no botão)"
t4 = "<a href=\"nav.html\">Nav page</a> se você não pode usar a barra de navegação"
nge = "Irá fazer escolhas inteligentes entre criar ou comprar sub-partes de um item."
fge = "Faz o mesmo item por 25 pontos. Mais rápido e fácil que outros guias, porém mais caro."
tge = "Irá criar sub-partes de um item ao invés de comprar, se possível. Normalmente mais caro que guias normais, mas pode ser menos complexo. Similar a guias de crafting que existiam antes de ACCG."
wit = "<strong>O que é isso?</strong> Guias de crafting para Guild Wars 2 que são sempre atualizados. Todos os guias são recalculados baseados nos preços atuais do Trading Post a cada hora, assumindo que o computador que roda o script esteja ligado e que o Anet API está acessível. Esses guias foram originalmente criados para amigos, mas baseado em sua popularidade com a comunidade do jogo, continuei a melhorá-los até chegar ao ponto atual. Esse script assume que existem \"infinitos\" itens a qualquer preço, então se forem todos comprados, ou houver poucos durante o período de atualização os preços podem estar errados até a próxima atualização."
nWarn = "<strong>[Aviso]</strong> Se você não vai fazer todo o guia de uma vez só, tenha certeza de salvá-lo em seu computador, já que estes guias podem e irão mudar."
rCost = "<strong>Dicas para reduzir custos:</strong> Salve uma cópia do guia e coloque Buy Orders para os materiais."
thanks2 = "Agradecimentos à guilda Dragonbrand Heroes ( <a href=\"http://dh.fantasius.com.br\">http://dh.fantasius.com.br</a> ) pela tradução em português. "
...
fGuides = "Guias Rápidos"
tGuides = "Guias Tradicionais"
cooking = "Cooking"
nHearts = "Sem Hearts"
tHearts = "Top 5 Hearts"
aHearts = "Todos os Hearts"
jc = "Jewelcrafting"
art = "Artificing"
hunt = "Huntsman"
wc = "Weaponcrafting"
