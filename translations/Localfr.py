...
blNotice     = u"Remarque: Si vous suivez le guide complet alors vous avez déjà acheté ces matériaux.  This buylist may be missing items that are used in later tiers, but are crafted in this tier.  Such as Lucent Motes."
