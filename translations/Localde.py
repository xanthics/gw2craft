...
blNotice     = u"Hinweis: Wenn Du dem kompletten Guide folgst, dann hast Du diese Gegenstände bereits gekauft.  This buylist may be missing items that are used in later tiers, but are crafted in this tier.  Such as Lucent Motes."
