...
eRecovery    = "Očekávaná návratnost"
fCost        = "Očekávaná koncová cena"
sList        = "Seznam prodejů"
bRecipes     = "NÁKUP RECEPTŮ"
collectibles = "POTŘEBNÝ MATERIÁL(Zjistěte, jestli nemáte v bance nebo Nakupte na tržišti)"
warning1     = "Neobnovujte tuto stránku."
warning2     = "Může se změnit. Aktualizováno"
moreInfo     = "Kdykoliv uvidíte tuto ikonu %s můžete si rozkliknout více informací."
soldVia      = "Prodáváno za %s za pomocí"
method       = ["Vendor (prodejce)",
                "Max Buyout",
                "Minimální prodejní cena"]
valuePer     = "za"
buyVendor    = "KUP U VENDORA (prodejce)"
mixedTP      = "Předchystáno (Kup na tržišti)"
rTP          = "Kup na tržišti"
make         = "Vytvoř"
discover     = "Objev"
expand       = "Ukaž všechny recepty k objevení"
collapse     = "Schovej všechny recepty k objevení"
tier         = "Tier %i. Level %i-%i"
buyList      = "Nákupní list(Pouze Tier %i)"
blNotice     = "Poznámka: Pokud postupujete od začátku podle průvodce, pak už jste tyto materiály pořídil.  This buylist may be missing items that are used in later tiers, but are crafted in this tier.  Such as Lucent Motes."
costRT       = "Cena: %s (Kumulativní cena: %s)"
level        = "Level"
finish       = "Nic.  Vše hotovo!"
updated      = "Aktualizováno"
note         = "<strong>Poznámka:</strong> Tyto ceny jsou počáteční náklady, nejsou z nich odečteny zisky z prodeje."
craft        = "Povolání"
tiers        = "Tier"
...
gw2spidy = "Tyto průvodci fungují také díky <a href=\"http://www.gw2spidy.com\">gw2spidy</a> a <a href=\"http://www.guildwarstrade.com/\">guildwarstrade</a>."
oThread  = "GW2 Oficiální Fórum - Diskuzní vlákno"
rThread  = "reddit Diskuzní vlákno"
gThread  = "guildwars2guru Diskuzní vlákno"
twitter  = "Twitter"
email    = "Email"
contact  = "Pokud máte nějaké otázky, komentáře, připomínky nebo jste našli chybu, prosím kontaktujte mě některou z těchto metod."
faq      = "FAQ"
question = "Otázka"
answer   = "Odpověď"
source   = "Zdrojový kód?"
q1       = "Kolik levlů můžu získat při výrobě?"
a11      = "Celkový počet zkušeností získaných na postavě při výrobě vychází z crafting levelu podle následující tabulky;"
a12      = "1-100 1% aktuálního levelu postavy na jeden crafting level"
a13      = "101-200 2% aktuálního levelu postavy na jeden crafting level"
a14      = "201-300 3% aktuálního levelu postavy na jeden crafting level"
a15      = "301-400 4% aktuálního levelu postavy na jeden crafting level"
a16      = "And these values scale to partial levels, like lvl 1, half full bar is 1.5% of a level. Získáním 400 bodů ve výrobě získáte teké 10 levelů na vaší postavě, je jedno na kterém levelu jste vyrábět začali."
a17      = "Existuje 1 vyjímka u xp odměn v rozmezí 1-15 jsou větší než aktuální xp potřebné pro tyto levely. ( <a href=\"http://wiki.guildwars2.com/wiki/Experience#Total_experience_gain_per_level\">zdroj</a> ) takže získáte okolo 13 levelů za dokončení veškeré výroby."
a18      = "This means you can level from 2-80 entirely from crafting as there are 8 crafts."
q2       = "Budou tyto návody správné, když někdo vykoupí všechen materiál X?"
a2       = "Tyto návody navrhují výrobu nebo nakupování materiálů na základě aktuálních cen na tržišti. Upravuje tedy navrhované předměty podle toho jak se mění jejich cena.  (Téměř) všechny možné recepty jsou porovnány před vygenerováním průvodce."
q3       = "Otázka na critical rate/šanci nebo crafting boosters (ke zvýšení počtu získaných zkušeností)."
a31      = "Tento script předpokládá 0% crit rate, protože criticaly redukují množství potřebných surovin k výrobě."
a32      = "Crafting booster přidává +50%, plus wvw and guild booster bonus, zvyšuje šanci na critical. Maximální bonus je 90%. Critical přidá 50% bonus výrobních zkušeností, který se sčítá s dalšími bonusy (objevení nového předmětu, masterwork a rare crafty). Crafting booster tak snižuje počet výrobních procesů k dosažení 400, ale nemá to vliv na počet získaných levlů na postavě (vždy 10 levelů)."
q4       = "Můžu použít nebo se odkazovat na tohoto průvodce?"
a4       = "Ano, ale berte v úvahu, že současný výstup se může změnit a já neposkytuji podporu. Také prosím o použití správných atributů ( xanthic.9478 a odkaz na tuto stránku)."
q5       = "Otázka zda brát ohled na ceny na tržišti nebo přidání hodnoty zisku při výkupu u prodejce."
a51      = "Zvažování tržních cen by přidalo risk při odhadování koncových cen, protože ceny jednotlivých materiálů jsou nestabilní a nakonec by se koncová cena mohla zvednout i o několik stříbrňáků. Momentálně poskytuji \"nejlepší odhad\" návratnosti nákladů založené na maximální nabídce nebo ceně u prodejce podle toho, která je větší."
a52      = "Taktéž neexistuje \"automatický\" způsob stanovení, že se daný předmět právě teď za tu cenu prodává."
q6       = "Jak je tento průvodce vytvořen?"
a6       = "Multi-part Python 3.7.3 script, který používá nenasytný algoritmus a cenné data z gw2spidy ke kalkulaci nejnižších počátečních nákladů a nejkratší cesty k získání konečného počtu zkušeností"
q7       = "Ne, já myslel jak funguje tento průvodce? (Jednoduchá odpověď)"
a7       = "Pro každou \"výrobu\", vygeneruji seznam materiálů, spočítám poměr nejvíc xp/nejmíň peněz, zvážím cesty výroby předmětu ze základních surovin nebo nákupu polotovarů a pak stanovým nejvýhodnější předmět k vytvoření."
q8       = "Ne, já myslel jak funguje tento průvodce? (Elaborát)"
a8       = "Nejdřív rozdělím výrobu na skupinky po 16 25 bodech(př. 0-24, 25-49).  Potom počínaje 375 spočítám (pro každý předmět, který dává xp) jeho poměr xp/základní cena a potom pro každou jeho součástku spočítám její poměr xp/základní cena a tak dále až se dostanu k součástce, která nemá recept na výrobu.  Součástky jsou určeny k výrobě, pokud není levnější je koupit, nebo se jejich výrobou nenavýší poměr xp/kupní cenu součástí.  A proto Vás někdy průvodce navede k výrobě ikdyž nákup je o něco levnější.  A potom co je vybrána nejlepší možnost, spočítají se změny xp (skrz všechny skupiny) a nejlepší možnost je znovu nalezena."
thanks   = "Děkuji lidem, kteří vytvořili průvodce předemnou; Qorthos, pwnuniversity, gw2wiz a guildwars-2-crafting. Bez vaší šablony bych tohle všechno nestvořil."

# index strings
fThings = "4 věci o kterých by jste měli vědět"
t1      = "<img src=\"/img/arrow.png\" alt=\"ARROW\"> kliknutím na tuto ikonku si rozevřete recept, nebo nákupní seznam"
t2      = "<input type=\"checkbox\"/> zaškrtněte si získané předměty v seznamu"
t3      = "Tier specifický nákupní seznam se objeví u všech průvodců kromě Cooking (klikněte na tlačítko)"
t4      = "<a href=\"nav.html\">Stromová struktura webu</a> pokud nemůžete použít horní menu"
nge     = "Chytře vyberou mezi výrobou nebo nákupem součástí předmětu."
fge     = "Vytvoří tolikrát stejný předmět kolikrát je potřeba pro zisk 25 bodů.  Rychlejší a jednodušší, ale dražší než normální."
tge     = "Vytvoří součásti předmětu, pokud je to možné místo nákupu.  Obvykle dražší než normální průvodce, ale může být méně komplexní.  Toto je podobné výrobním průvodcům, kteří existovali před ACCG."
wit     = "<strong>Co je toto za stránku?</strong> Stále aktuální výrobní průvodce pro Guild Wars 2. Všechny průvodce jsou spočítány na základě aktuálních tržních cen jednou za hodinu za předpokladu, že počítač se skriptem běží a gw2spidy je dostupné. Tento průvodce byl původně určen kamarádům, ale na základě zájmu ze strany Guild Wars 2 komunity, pokračuji ve vylepšování až do současné podoby.  Skript bere v úvahu určité \"konečné\" množství daného předmětu za danou cenu, takže když se vyprodají, nebo jich je velmi málo během aktualizace, tabulka s cenami může být chybná až do další aktualizece."
nWarn   = "<strong>[Poznámka]</strong> Pokud nechcete projít celých výrobním procesem najednou, tak si ho prosím uložte do svého PC. Protože průvodce se neustále mění."
rCost   = "<strong>Tip na snížení nákladů:</strong> Uložte si průvodce a dejte si nabídky na materiál na tržiště."
thanks2 = "Děkuji za překladů Vítězslav Jaroš."

# nav strings
navNotice = "Tohle je stránka s navigací stránek, používejte ji pouze pokud Vám nefunguje horní navigační menu.  Pokud překládáte tuto stránku prosím napište mi na email gw2crafts@live.com, přiložte název jazyka a zdrojový soubor jazykové mutace a já se o zbytek postarám."
navLang   = "Jazyk"

#nav page headers and guide names
home    = "Domů"
nGuides = "Normalní průvodce"
fGuides = "Rychlý průvodce"
tGuides = "Tradiční průvodci"
cooking = "Cooking"
nHearts = "Bez srdíčka"
tHearts = "Top 5 srdíček"
aHearts = "Všechny srdíčka"
jc      = "Jewelcrafting"
art     = "Artificing"
hunt    = "Huntsman"
wc      = "Weaponcrafting"
