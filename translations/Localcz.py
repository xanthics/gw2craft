...
a6       = "Multi-part Python 3.7.3 script, který používá nenasytný algoritmus a cenné data z Anet API ke kalkulaci nejnižších počátečních nákladů a nejkratší cesty k získání konečného počtu zkušeností"
