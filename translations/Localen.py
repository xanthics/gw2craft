...
slLabel      = "Start at level:"
slHint       = "(0 = full guide; raise to skip tiers you have already finished)"
slWarn       = "Note: tier buy lists cover the whole tier (multiples of 75); a mid-tier choice may overstate what you still need."
...
a6       = "Multi-part Python 3.7.3 script that uses a greedy algorithm and price data from Anet API to calculate the lowest initial gold method of leveling a craft using in game formulas"
